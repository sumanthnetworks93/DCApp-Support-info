/**
 * Privacy Policy — word-for-word from TermsFeed (Desi Connects).
 * Source: https://www.termsfeed.com/live/ad8b5f8e-249d-4d3d-9128-963334f1f7e1
 */
import { APP_NAME, PRIVACY_EMAIL } from "../constants";
import { privacyPolicyMeta } from "./siteContent";

export function PrivacyPolicyBody() {
  const { companyName, country, phone, contactWebsite } = privacyPolicyMeta;
  ...
  return (
    <>
      ...
      <ul>
        ...
        <li>
          <strong>Application</strong> refers to {APP_NAME}, the software program provided by the
          Company.
        </li>
        <li>
          <strong>Company</strong> (referred to as either &quot;the Company&quot;, &quot;We&quot;,
          &quot;Us&quot; or &quot;Our&quot; in this Privacy Policy) refers to {companyName}.
        </li>
        <li>
      ...
      <p>
        ...
        below are maximum periods (&quot;up to&quot;) and We may delete or anonymize data sooner
      ...
      <ul>
        ...
        <li>
          ...
          that cannot be linked back to You. This anonymized data may be retained indefinitely for
      ...
      <ul>
        <li>
          By email: <a href={`mailto:${PRIVACY_EMAIL}`}>{PRIVACY_EMAIL}</a>
        </li>
        <li>
